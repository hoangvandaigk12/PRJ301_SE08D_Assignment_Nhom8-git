 ...
 * @author AD
 */
@WebServlet(name = "ListHotFlowerServlet", urlPatterns = {"/ListHotFlowerServlet"})
public class ListHotFlowerServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (session.getAttribute("user") != null) {
            try {
                ...
                ArrayList<FlowerDTO> list = fdao.getListHotFlower();
                if (list != null) {
